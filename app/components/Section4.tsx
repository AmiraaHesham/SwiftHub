        ...
        <div className='mt-32 cursor-default md:block xs:flex xs:flex-col xs:justify-center' >
            <div >
                <div className='flex justify-between items-center'>
                    <h1 className='lg:text-6xl xs:text-3xl lg:w-[600px] xs:w-[300px]   '>Comprehensive  Logistics Services</h1>
                    <div>
            ...
            <div className='flex justify-center mt-10 items-center w-full'>
                <div className='mt-[40px] grid xl:grid-cols-3 lg:grid-cols-2 xs:grid-cols-1 gap-y-10 gap-x-28 '>
